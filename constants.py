...
class UUIDS(object):
    ...
    SERVICE_MIBAND1 = BASE % 'fee0' #HRDW
    SERVICE_MIBAND2 = BASE % 'fee1'

    #SERVICE_UNKNOWN_1 = BASE % '1800'
    #SERVICE_UNKNOWN_2 = BASE % '1801'
    #SERVICE_UNKNOWN_3 = BASE % '0001530-0000-3512-2118-0009af100700'
    SERVICE_ALERT = BASE % '1802'
    SERVICE_ALERT_NOTIFICATION = BASE % '1811'
    SERVICE_HEART_RATE = BASE % '180d' #not available on HRX
